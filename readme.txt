...
LEADER:
   Somintac, Diego Derich C.
   - Project Management: Pull Requests, Issues, Milestones, Branches
   - Documentation: Defined & Described Git Merge
   - Web Development: Handled Home Page Section

MEMBERS:

   Bote, Carl Joseph S.
   - Documentation: Defined & Described Git Clone
   - Web Development: Handled About Page Section

   Cortez, Jerome R.
   - Documentation: Defined & Described Git Pull
   - Web Development: Handled Team Page Section

   Florendo, Samuel C.
   - Documentation: Defined & Described Git Push
   - Web Development: Handled Services Page Section

   Manalo, Reihann Karl Adrianne O.
   - Documentation: Defined & Described Git Fetch
   - Web Development: Handled Gallery Page Section

   Santiago, Lean R.
   - Documentation: Defined & Described Issue & Branch
   - Web Development: Handled Blog Page Section

   Tacdol, Michael Angelo S.
   - Documentation: Defined & Described Milestone
   - Web Development: Handled Contact Page Section

============================================================
               (c) 2026 - Capstone IPT2 Team
============================================================
